  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Selector<ProductDetailService, DetailState>(
      ...
      body: Selector<ProductDetailService, DetailState>(
        selector: (_, service) => service.state,
        builder: (_, state, __) {
          if (state is LoadedState) {
            return SafeArea(
                                ...
                                (e) => Container(
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                      image: NetworkImage(state.detail.pics),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                            ...
                            child: Row(
                              ...
                              children: [1, 2, 3, 4, 5].map((entry) {
                                return GestureDetector(
                                  onTap: () =>
                                      _controller.animateToPage(entry - 1),
                                  child: AnimatedContainer(
                                    duration: const Duration(milliseconds: 500),
                                    width:
                                        _currentPage == entry - 1 ? 24.0 : 12.0,
                                    height: 12.0,
